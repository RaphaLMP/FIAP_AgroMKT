  ...
  return (
    <div className="flex items-center justify-center h-screen w-full">
      ...
      <div className="flex items-center justify-center bg-white w-full md:w-1/2 xl:w-1/3 p-6">
        <form className="flex flex-col w-10/12 md:w-3/4">
          <div className="p-4">
      ...
      <div className="hidden lg:flex bg-cover bg-center w-1/2 h-full" style={{ backgroundImage: "url('images/agricultura.jpg')" }}></div>
    </div>
  );
};
